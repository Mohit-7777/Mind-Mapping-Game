...
function change(x) {
  ...
  //Flip
    ...
    if (rem==0) {
          ...
          setTimeout(function() {
              $("#ol").html(`<center><div id="iol"><h2>Kudos Champ !</h2><p style="font-size:23px;padding:10px;">You completed the ${mode} mode in ${moves} moves.<br/> You completed this in  ${time} .</p><p style="font-size:18px"><br/>Play Again ?</p><button onclick="start(3, 4)">3 x 4</button> <button onclick="start(4, 4)" style="w">4 x 4</button><button onclick="start(4, 5)">4 x 5</button><button onclick="start(5, 6)">5 x 6</button><button onclick="start(6, 6)">6 x 6</button><br/><p style="font-size:13px">Congratulation You Won</p></div></center>`);
              $("#ol").fadeIn(750);
          }, 1500);
    }
  }
